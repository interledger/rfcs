...
- A **payment** is sending value from one to another but it doesn't mean settled necessarily that is explained below.
...
- Connections
  ...
  - (C) SPSP over HTTPS
    ...
    - To determine payment information such as a shared secret, a destination address and so forth, an application connects to SPSP server over HTTPS.
- Protocols and related specifications
  ...
  - (7) SPSP
    ...
    - SPSP is used to determine payment information such as a shared secret, a destination address and so forth.
  - (8) ASN.1
...
- Functions
  ...
  - (12) Bilateral Ledger
    ...
    - A bilateral ledger tracks the balance of two nodes connected each other, including unsettled payments.
