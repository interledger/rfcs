...
| **R03** | **Superfluous Source Amount** | The transfer amount is sufficient to cover the costs of the payment, but this error is thrown as a courtesy, to warn that a lower transfer amount would also suffice. The sender SHOULD obtain a new quote and retry the Interledger payment with that adjusted transfer amount. |
