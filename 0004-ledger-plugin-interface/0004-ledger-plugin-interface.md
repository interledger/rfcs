...
| [**error**](#event-error-) | `( ) ⇒` |
| [**incoming_transfer**](#event-*_transfer-) | <code>( transfer:[Transfer](#transfer) ) ⇒</code> |
| [**incoming_prepare**](#event-*_prepare-) | <code>( transfer:[Transfer](#transfer) ) ⇒</code> |
| [**incoming_fulfill**](#event-*_fulfill-) | <code>( transfer:[Transfer](#transfer), fulfillment:String ) ⇒</code> |
| [**incoming_reject**](#event-*_reject-) | <code>( transfer:[Transfer](#transfer), rejectionReason:[RejectionMessage](#class-rejectionmessage) ) ⇒</code> |
| [**incoming_cancel**](#event-*_cancel-) | <code>( transfer:[Transfer](#transfer), cancellationReason:[RejectionMessage](#class-rejectionmessage) ) ⇒</code> |
...
| [**outgoing_transfer**](#event-*_transfer-) | <code>( transfer:[Transfer](#transfer) ) ⇒</code> |
| [**outgoing_prepare**](#event-*_prepare-) | <code>( transfer:[Transfer](#transfer) ) ⇒</code> |
| [**outgoing_fulfill**](#event-*_fulfill-) | <code>( transfer:[Transfer](#transfer), fulfillment:String ) ⇒</code> |
| [**outgoing_reject**](#event-*_reject-) | <code>( transfer:[Transfer](#transfer), rejectionReason:[RejectionMessage](#class-rejectionmessage) ) ⇒</code> |
| [**outgoing_cancel**](#event-*_cancel-) | <code>( transfer:[Transfer](#transfer), cancellationReason:[RejectionMessage](#class-rejectionmessage) ) ⇒</code> |
